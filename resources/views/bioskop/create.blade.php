...
<br>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <textarea id="alamat_bioskop" name="alamat_bioskop" class="form-control" placeholder="Masukkan Alamat Bioskop" autocomplete="off"></textarea>
